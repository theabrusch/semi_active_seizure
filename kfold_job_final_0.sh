...
python3 kfoldmain.py --run_folder kfold_temple --job_name finalsplit_0 --file_path /work3/theb/temple_seiz_full.hdf5 --window_length 2 --bckg_stride 0.5 --seiz_stride 0.5 --bckg_rate_val 1 --bckg_rate_train 1 --lr 3.63e-6 --epochs 150 --weight_decay 0.00605 --glob_avg_pool False --padding True --anno_based_seg True --dropoutprob 0.4709 --cnn_dropoutprob 0.3246 --optimizer RMSprop --seiz_classes 'fnsz' 'gnsz' 'cpsz' 'spsz' 'tcsz' 'seiz' 'absz' 'tnsz' 'mysz' --eval_seiz_classes 'fnsz' 'gnsz' 'cpsz' 'spsz' 'tcsz' 'seiz' 'absz' 'tnsz' 'mysz' --split 2 --n_splits 5 --onlytrainseiz None --save_best_model True --val_split None
