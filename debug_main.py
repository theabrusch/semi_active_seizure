...
parser.add_argument('--eval_seiz_classes', type = eval, default=['fnsz', 'gnsz', 'cpsz', 'spsz', 'tcsz', 'seiz', 'absz', 'tnsz', 'mysz'])
...
parser.add_argument('--seizure_strat', type = eval, default = True)
...
parser.add_argument('--val_subj', nargs = '+', default=None)
parser.add_argument('--test_subj', nargs = '+', default=None)
