...
python3 main.py --file_path /work3/theb/boston_scalp.hdf5 --bckg_stride 23 --seiz_stride 23 --bckg_rate_val 1 --bckg_rate_train 1 --lr 0.0013 --prefetch_data_from_seg True --epochs 50 --weight_decay 0.02 --train_val_test False --use_weighted_loss False --padding True --standardise False --anno_based_seg False --dropoutprob 0.4 --window_length 23 --model_type AttBiLSTM
pkill nvidia-smi
