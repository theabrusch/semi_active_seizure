...
python3 main.py --job_name temple_test_lowdropout_globavg --file_path /work3/theb/temple_seiz.hdf5 --window_length 2 --bckg_stride 2 --seiz_stride 0.5 --bckg_rate_val 1 --bckg_rate_train 1 --lr 1e-5 --prefetch_data_from_seg True --epochs 200 --weight_decay 1e-2 --train_val_test True --glob_avg_pool True --padding False --standardise False --anno_based_seg True --dropoutprob 0.3 --optimizer RMSprop --use_weighted_loss True --scheduler MultistepLR --milestones [100, 200]
pkill nvidia-smi
