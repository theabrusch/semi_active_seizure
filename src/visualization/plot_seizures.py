...
# reference
record = file[seizure_types['cpsz'][-1]]
signal = record['TCP'][:,0].T
sig_time = np.arange(0, len(signal)/250, step=1/250) 
# reference
ax_n = 0
ax[ax_n].set_xticks(np.arange(0, 51, step=2), labels=[])
ax[ax_n].set_yticks([])
ax[ax_n].plot(sig_time, signal, alpha = 0.3)
ax[ax_n].text(4,0.8,'0.11', fontsize = 14)
ax[ax_n].axvspan(10, 22,np.min(signal), np.max(signal), facecolor = 'bisque', label = 'Seizure (p>0.50)')
ax[ax_n].text(15,0.8,'0.80', fontsize = 14)
#ax[ax_n].axvspan(22, 24,np.min(signal), np.max(signal), facecolor = 'lightsalmon')
ax[ax_n].text(22,0.8,'0.18', fontsize = 14)
ax[ax_n].axvspan(24, 28,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(25,0.8,'0.80', fontsize = 14)
ax[ax_n].text(29,0.8,'0.39', fontsize = 14)
ax[ax_n].axvspan(32, 36,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(33,0.8,'0.59', fontsize = 14)
ax[ax_n].text(38,0.8,'0.39', fontsize = 14)
ax[ax_n].axvspan(42, 44,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(42,0.8,'0.90', fontsize = 14)
ax[ax_n].text(45.5,0.8,'0.39', fontsize = 14)

ax[ax_n].set_ylim([-10,30])
...
ax[ax_n].plot(sig_time, signal, alpha = 0.3)
ax[ax_n].text(4,0.8,'0.11', fontsize = 14)
ax[ax_n].axvspan(10, 22,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(15,0.8,'0.80', fontsize = 14)
ax[ax_n].text(22,0.8,'0.18', fontsize = 14)
ax[ax_n].axvspan(24, 28,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(25,0.8,'0.80', fontsize = 14)
ax[ax_n].text(34,0.8,'0.39', fontsize = 14)
ax[ax_n].axvspan(42, 44,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(42,0.8,'0.90', fontsize = 14)
ax[ax_n].text(45.5,0.8,'0.39', fontsize = 14)
...
ax[ax_n].plot(sig_time, signal, alpha = 0.3)
ax[ax_n].text(4,0.8,'0.11', fontsize = 14)
ax[ax_n].axvspan(10, 28,np.min(signal), np.max(signal), facecolor = 'bisque')
ax[ax_n].text(18,0.8,'0.80', fontsize = 14)
ax[ax_n].text(38,0.8,'0.39', fontsize = 14)
